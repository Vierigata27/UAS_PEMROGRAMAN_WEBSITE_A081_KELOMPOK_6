<?php
require 'koneksi.php';
$data = tampil("SELECT * FROM pengaduan_kekerasan");
    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?= $row["tempat"] ?></td>
                <td>
                <a href="kirim2.php?kode=<?= $row["no_pengaduan"]; ?>">Kirim</a>
                <a href="hapus2.php?kode=<?= $row["no_pengaduan"]; ?>">hapus</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
