...
if(isset($_POST['submit'])) {
    if(pengaduan_fasilitas($_POST) > 0) {
            ...
            <div class="main-container">
                <div class="sec_main">
                    ...
                    <div class="img_report">
                        <!-- <p>Masukkan Bukti Disini</p> -->
                        <label for="imageClip">
                            <a class="btn btn-warning btn-sm" rel="nofollow"><span class='glyphicon glyphicon-paperclip'></span> <img src="" alt=""></a>
                        
                        <input type="file" name="gambar" id="userImage">
                        </label>
                    </div>
                </div>
                <div class="btn-next">
