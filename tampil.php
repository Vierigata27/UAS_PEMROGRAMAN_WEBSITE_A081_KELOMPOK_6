<?php
require 'koneksi.php';
$data = tampil("SELECT * FROM pengaduan_fasilitas");
    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?= $row["status"] ?></td>
                <td><img src="gambar//<?php echo $row["gambar"]; ?>" alt="Gambar" /></td>
                <td><?= $row["waktu"] ?></td>
                <td><?= $row["tempat"] ?></td>
                <td>
                <a href="kirim.php?kode=<?= $row["no_pengaduan"]; ?>">Kirim</a> 
                <a href="hapus.php?kode=<?= $row["no_pengaduan"]; ?>">hapus</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
